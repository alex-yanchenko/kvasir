...
const server = new McpServer(
  { name: "kvasir", version: "0.1.0" },
  {
    ...
    instructions: [
      ...
      "☐ 4. Author the spec (shape in the publish_walkthrough description): set overview = 2-4 plain-text sentences (what it does, approach/architecture, key risks) — shown in the panel's Overview popup AND fed to chat as background; write it for a human reader opening the PR cold, not just as model context.",
